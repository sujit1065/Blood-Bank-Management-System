...
/**
 * Servlet implementation class HospitalCtl
 */
@WebServlet(name = "HospitalCtl", urlPatterns = { "/ctl/hospital" })
public class HospitalCtl extends BaseCtl {
	...
	protected BaseBean populateBean(HttpServletRequest request) {
		log.debug("HospitalCtl Method populatebean Started");
		...
		if(bean.getId()==0) {
			...
			log.debug("HospitalCtl Method populatebean Ended");
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if (OP_SAVE.equalsIgnoreCase(op)) {
            ...
            try {
                if (id > 0) {
                	HospitalBean hBean=model.findByPK(id);
                	...
                	uBean.setRoleId(RoleBean.HOSPITAL);
        ...
        log.debug("HospitalCtl Method doPostEnded");
	}

	@Override
	protected String getView() {
		// TODO Auto-generated method stub
		return BBMView.HOSPITAL_VIEW;
	}
