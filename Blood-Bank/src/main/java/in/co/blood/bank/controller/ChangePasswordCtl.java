...
import in.co.blood.bank.exception.RecordNotFoundException;
...
public class ChangePasswordCtl extends BaseCtl {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (OP_SAVE.equalsIgnoreCase(op)) {
			...
			ServletUtility.redirect(BBMView.MY_PROFILE_CTL, request, response);
			return;
		}

		ServletUtility.forward(BBMView.CHANGE_PASSWORD_VIEW, request, response);
	...
	protected String getView() {
		...
		return BBMView.CHANGE_PASSWORD_VIEW;
	}
