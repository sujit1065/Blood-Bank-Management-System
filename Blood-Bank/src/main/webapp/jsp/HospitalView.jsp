<%@page import="in.co.blood.bank.controller.HospitalCtl"%>
...
<div class="col-md-5">
    <div class="form-area">  
        <form role="form" action="<%=BBMView.HOSPITAL_CTL%>" method="post" >
        
       <jsp:useBean id="bean" class="in.co.blood.bank.bean.HospitalBean"
        ...
        <br style="clear:both">
                    <h3 style="margin-bottom: 15px; text-align: left: ;">Hospital</h3>
              ...
              <b><font color="Green"> <%=ServletUtility.getSuccessMessage(request)%>
						...
						<font   color="red"> <%=ServletUtility.getErrorMessage("confirmPassword", request)%></font>
        					...
        					<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=HospitalCtl.OP_SAVE%>">&nbsp;or&nbsp;
								<input type="submit" name="operation"
								class="btn btn-primary pull-right" value="<%=HospitalCtl.OP_RESET%>">
        </form>
    </div>
</div>
</div> </div> <!--feedback-->
